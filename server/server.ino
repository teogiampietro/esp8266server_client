...
void handleUpdate() {
  ...
  sensor_value4 = server.arg("value4");
  concatenar3valores(sensor_value1, sensor_value2, sensor_value3,(String)sensor_value4);
  server.send(200, "text/plain", String(cadena));
}

String concatenar3valores(float value1, float value2, int value3, String value4) {
  cadena = "";
  cadena += "Temperatura: ";
  cadena += value1;
  cadena += "C / Humedad: ";
